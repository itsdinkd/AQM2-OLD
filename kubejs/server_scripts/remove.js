...
onEvent('recipes', event => {
  ...
  // Hover Pets
  event.remove({output: "hoverpets:blaze_pet"});
  event.remove({output: "hoverpets:creeper_pet"});
  event.remove({output: "hoverpets:panda_pet"});
 ...
 // Croptosis
  ...
  // Mining Utilities
  event.remove({output: 'miningutility:escape_rope'})
  event.remove({output: 'miningutility:mining_helmet'})
